...
def others(update, context):
    ...
    if trigger_find:
        context.bot.send_message(
        chat_id = update.effective_chat.id,
        text = 'Please include a picture and a brief description of the item.'
    )
    else:
        context.bot.send_message(
        chat_id = update.effective_chat.id,
...
def report(update, context):
    context.bot.send_message(
        chat_id = update.effective_chat.id,
        text = 'Please upload a photo and a brief description of the item you found.'
    )
    return RESPONSE
...
def costumes_attires(update, context):
    ...
    if trigger_find:
        context.bot.send_message(
        chat_id = update.effective_chat.id,
        text = 'Please include a picture and a brief description of the item you found.'
    )
    else:
        context.bot.send_message(
        chat_id = update.effective_chat.id,
