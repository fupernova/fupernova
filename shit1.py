...
from telegram import ChatAction, ParseMode, InlineKeyboardButton, InlineKeyboardMarkup, InputMediaPhoto, InputMedia
...
# Handler for if reporting found items
...
def others(update, context):
    ...
    if trigger_find:
        context.bot.send_message(
        chat_id = update.effective_chat.id,
        text = 'Please submit a picture of the item and a brief description'
        )
